...
/**
 * Persists Validakey instance ids in the WordPress options table.
 *
 * Prefer this over {@see \Validakey\Instance\FileInstanceStore} under
 * wp-content: the instance id is a bearer secret and that path may be
 * web-servable. Autoload is left off so the option is loaded only when a
 * Validakey call needs it.
 *
 ...
 */
final class OptionsInstanceStore implements InstanceStore
{
